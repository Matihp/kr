...
const Testimonials = () => {
  ...
  const keenSliderPreviousDesktopRef = useRef<HTMLButtonElement | null>(null);
  const keenSliderNextDesktopRef = useRef<HTMLButtonElement | null>(null);
      ...
      <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-10">
        <div className="grid  grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
          <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <div className="hidden md:mt-8 lg:flex md:gap-4">
              <button
        ...
        <div className="mt-8 flex justify-center gap-4 lg:hidden">
          <button
            ...
            ref={keenSliderPreviousTabletRef}
