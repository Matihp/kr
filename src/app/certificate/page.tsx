...
function page() {
  return (
    <>
      <section className="w-full relative bg-white px-10 lg:px-15 py-12 md:pt-28 lg:pt-40 ">
      <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div>
        <div className="space-y-4 flex flex-col justify-center items-center">
          ...
          <p className="max-w-[600px] text-center text-muted-foreground md:text-xl">
            Obtén certificaciones gratuitas en diferentes áreas tecnológicas y
            destaca tus habilidades en el mercado freelance.
          </p>
          <div className="flex gap-2">
            <Button variant="default" className="z-10">Obtén tu Certificación</Button>
            <Button variant="outline" className="z-10">Conoce los Beneficios</Button>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Obtén certificaciones acreditadas en diversos campos
                tecnológicos y úsalas para destacar tus habilidades y encontrar
                trabajos a través de nuestra plataforma de proyectos.
              </p>
            </div>
          </div>
              ...
              <ul className="grid gap-6">
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-muted-foreground">
                      Demuestra tus habilidades en HTML, CSS, JavaScript y
                      frameworks como React, Angular y Vue.
                    </p>
                  </div>
                </li>
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-muted-foreground">
                      Acredita tus conocimientos en diseño de interfaces,
                      experiencia de usuario y herramientas como Figma y Adobe
                      XD.
                    </p>
                  </div>
                </li>
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-muted-foreground">
                      Obtén certificaciones en desarrollo de aplicaciones
                      móviles para iOS y Android, incluyendo frameworks como
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Tenemos certificaciones gratuitas disponibles para freelancers
                de diferentes áreas tecnológicas.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-8">
            <div className="grid gap-1 p-6 bg-slate-50 rounded-lg shadow-sm">
              <CodeIcon className="h-8 w-8 text-primary" />
              <h3 className="text-xl font-bold">Desarrollo Web</h3>
              <p className="text-muted-foreground">
                Certificaciones en HTML, CSS, JavaScript, React, Angular y más.
              </p>
            </div>
            <div className="grid gap-1 p-6 bg-slate-50 rounded-lg shadow-sm">
              ...
              <p className="text-muted-foreground">
                Certificaciones en SQL, MySQL, PostgreSQL, MongoDB y más.
              </p>
            </div>
            <div className="grid gap-1 p-6 bg-slate-50 rounded-lg shadow-sm">
              ...
              <p className="text-muted-foreground">
                Certificaciones en AWS, Azure, GCP y más.
              </p>
            </div>
            <div className="grid gap-1 p-6 bg-slate-50 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold">Desarrollo Móvil</h3>
              <p className="text-muted-foreground">
                Certificaciones en iOS, Android, Flutter y más.
              </p>
            </div>
            <div className="grid gap-1 p-6 bg-slate-50 rounded-lg shadow-sm">
              ...
              <p className="text-muted-foreground">
                Certificaciones en Machine Learning, Deep Learning y más.
              </p>
            </div>
            <div className="grid gap-1 p-6 bg-slate-50 rounded-lg shadow-sm">
              ...
              <p className="text-muted-foreground">
                Certificaciones en Ethical Hacking, Pentesting y más.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
          <div className="space-y-2">
            ...
            <p className="max-w-[600px] text-muted-foreground mxlg:text-center md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Obtén más proyectos y destaca tus habilidades con las
              certificaciones gratuitas.
            </p>
          </div>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Desde principiantes hasta expertos, tenemos certificaciones
              gratuitas para todos los niveles de habilidad.
            </p>
          </div>
