    ...
    <div className="max-w-md md:mt-28 w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 mb-10 shadow-input bg-white dark:bg-black">
      ...
      <form className="mt-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <LabelR htmlFor="firstname">First name</LabelR>
            <InputR id="firstname" placeholder="Tyler" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <LabelR htmlFor="lastname">Last name</LabelR>
            <InputR id="lastname" placeholder="Durden" type="text" />
          </LabelInputContainer>
        </div>
        ...
        <LabelInputContainer className="mb-4">
          <LabelR htmlFor="password">Confirm password</LabelR>
          <InputR id="password" placeholder="••••••••" type="password" />
        </LabelInputContainer>
